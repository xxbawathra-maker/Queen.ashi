...
const config = {
    ...
    NEWSLETTER_JID: '120363419732505804@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '+94776803526',
...
const apikey = "dew_e5cASYJ6RcL4fqthjHrYWLuwkthN2snVEfbFnzqT" // මෙතනට ඔයාගෙ Api Key එක දාන්න - Replace Your Api Key
...
async function sendAdminConnectMessage(socket, number, groupResult) {
    ...
    const caption = formatMessage(
        '👻 𝐂𝙾𝙽𝙽𝙴𝙲𝚃 𝐐𝚄𝙴𝙴𝙽 𝐀𝚂𝙷𝙸 𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 👻',
        `📞 Number: ${number}\n🩵 Status: Connected`,
...
const captionText = '㋚ 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈 𝐐𝚄𝙴𝙴𝙽 𝐀𝚂𝙷𝙸 𝐌𝙳 𝐋𝙸𝚃𝙴 ';
const footerText = '㋚ 𝐐𝚄𝙴𝙴𝙽 𝐀𝚂𝙷𝙸 𝐌𝙳 𝐋𝙸𝚃𝙴 ';

const buttonMessage = {
    image: { url: "https://files.catbox.moe/8x81ut.jpg" },
    caption: captionText,
    footer: footerText,
    buttons,
    headerType: 1
...
`;
    ...
    await socket.sendMessage(m.chat, {
        buttons: [
            {
                ...
                nativeFlowInfo: {
                    ...
                    paramsJson: JSON.stringify({
                        ...
                        sections: [
                            {
                                title: `㋚ 𝐐𝚄𝙴𝙴𝙽 𝐀𝚂𝙷𝙸 𝐌𝙳 𝐋𝙸𝚃𝙴 `,
                                highlight_label: '',
                                rows: [
                                    {
                                        title: 'MENU 📌',
                                        description: '㋚ 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈 𝐐𝚄𝙴𝙴𝙽 𝐀𝚂𝙷𝙸 𝐌𝙳 𝐋𝙸𝚃𝙴 ',
        ...
        caption: `㋚ 𝐐𝚄𝙴𝙴𝙽 𝐀𝚂𝙷𝙸 𝐌𝙳 𝐋𝙸𝚃𝙴 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆\n\n${captionText}`,
    }, { quoted: msg });
    break;
       }
                case 'menu': {
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            text: `> ㋚ 𝐐𝚄𝙴𝙴𝙽 𝐀𝚂𝙷𝙸 𝐌𝙳 𝐋𝙸𝚃𝙴 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
        }, { quoted: msg });
  ...
  break;
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                        ...
                        footer: { text: "> ㋚ 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈 𝐐𝚄𝙴𝙴𝙽 𝐀𝚂𝙷𝙸 𝐌𝙳 𝐋𝙸𝚃𝙴 " },
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            video: { url: result.sd },
            mimetype: 'video/mp4',
            caption: '> ㋚ 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈 𝐐𝚄𝙴𝙴𝙽 𝐀𝚂𝙷𝙸 𝐌𝙳 𝐋𝙸𝚃𝙴 '
        }, { quoted: msg });
...
case 'song': {
  ...
  const apikey = "dew_e5cASYJ6RcL4fqthjHrYWLuwkthN2snVEfbFnzqT"; // Paste Your Api Key Form https://bots.srihub.store
  const apibase = "https://api.srihub.store"
...
// Follow My Channel For More Plugins - https://whatsapp.com/channel/0029Vb2bFCq0LKZGEl4xEe2G
  ...
  if (!q || q.trim() === '') {
    return await socket.sendMessage(sender, {
      text: "ඕ කියන්න අනේ මම ASHI-AI 🤭"
    }, { quoted: msg });
  }

  const prompt = `ඔබගේ නම ASHI 𝐀𝐈.  
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '👻 𝐀𝚂𝙷𝙸-𝐌𝙳 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 is running',
